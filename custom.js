...
$( document ).ready(function() {
	...
	//redirect 
	$('#asset-31b329d3c692-4786-92af-0bd587eb13d4 a.c-banners__button.c-button').click(function() {
		e.preventDefault();
		$(this).attr('href', 'https://www.bauer.com/en-US/hockey-sticks/supreme-sticks/');
	});
	...
	//add USD to canadian pricing now 

	function addUSDToPricing() {
	try{
		if(window.location.href.indexOf("/fr") > -1) {
			var price1 = $('.c-product-tile__price.product-pricing');
			var price2 = $('.c-product-details__price.product-price');
			var price3 = $('.price-above-cart');
			var price4 = $('.c-mini-cart__subtotals span.value');
			var price5 = $('.c-mini-cart__product__price');
			var price6 = $('.price-sales');
			var price7 = $('td.order-value');

			var usDollars = $('<span>USD</span>');
			usDollars.prependTo(price1);
			usDollars.prependTo(price2);
			usDollars.prependTo(price3);
			usDollars.prependTo(price4);
			usDollars.prependTo(price5);
			usDollars.prependTo(price6);
			usDollars.prependTo(price7);
		}
	}catch {
	...
	function addSAaleBadge() {
		try{
			if(window.location.href.indexOf("hockey-sticks/supreme-sticks") > -1) {
				var sale = $('<div class="sale--badge">sale</div>');
				var sale_french = $('<div class="sale--badge">vente</div>');
