            ...
            <div class="nm-row">
                <div class="col-xs-12">
                    ...
                    <div class="summary entry-summary">
                        ...
                        ?>
			<div class="pdp-logo-wrapper <?php the_field('hide_group'); ?>">
			<br/>
				<p>BUY NOW</p>
				<div class="pdp-logo-grid">
					<a href="<?php the_field('retailer_link_1'); ?>" class="logo-<?php the_field('hide_1'); ?> pdp-logo-square" target="_blank" ><img src="<?php the_field('retailer_image_1'); ?>"/></a>
					<a href="<?php the_field('retailer_link_2'); ?>" class="logo-<?php the_field('hide_2'); ?> pdp-logo-square" target="_blank" ><img src="<?php the_field('retailer_image_2'); ?>"/></a>
					<a href="<?php the_field('retailer_link_3'); ?>" class="logo-<?php the_field('hide_3'); ?> pdp-logo-square" target="_blank" ><img src="<?php the_field('retailer_image_3'); ?>"/></a>
				</div>
				<div class="pdp-logo-grid">
					<a href="<?php the_field('retailer_link_4'); ?>" class="logo-<?php the_field('hide_4'); ?> pdp-logo-square" target="_blank" ><img src="<?php the_field('retailer_image_4'); ?>"/></a>
					<a href="<?php the_field('retailer_link_5'); ?>" class="logo-<?php the_field('hide_5'); ?> pdp-logo-square" target="_blank" ><img src="<?php the_field('retailer_image_5'); ?>"/></a>
					<a href="<?php the_field('retailer_link_6'); ?>" class="logo-<?php the_field('hide_6'); ?> pdp-logo-square" target="_blank" ><img src="<?php the_field('retailer_image_6'); ?>"/></a>
				</div>
			</div>
                       <!-- Changing the physical placement of the "Share This" feature is done in the "wc-template-hooks.php" in the Woocommerce plugin" -->
