...
remove_action( 'woocommerce_before_single_product_summary', 'woocommerce_show_product_images', 20 );
add_action( 'woocommerce_before_single_product_summary', 'mygtry', 21 );
//
}
...
function mygtry() {
    ...
    echo '<div class="woocommerce-product-gallery">';
        ...
        foreach( $attachment_ids as $attachment_id ) {
            ...
            echo '<div class="col-md-6" style="background: #F3F3F3; padding: 10px; margin-bottom: 20px;">' . wp_get_attachment_image($attachment_id, 'full') . '</div>';
